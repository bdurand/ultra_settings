...
RSpec.describe UltraSettings::ConfigurationView do
  ...
  describe "super_settings_api_path" do
    it "renders edit buttons when super_settings_api_path is set", settings: {} do
      html = UltraSettings::ConfigurationView.new(TestConfiguration.instance, super_settings_api_path: "/super_settings").render
    ...
    it "does not render edit buttons when super_settings_api_path is nil", settings: {} do
      html = UltraSettings::ConfigurationView.new(TestConfiguration.instance, super_settings_api_path: nil).render
